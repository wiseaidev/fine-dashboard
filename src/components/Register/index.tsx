...
const Register = () => {
  ...
  const handleSubmit = async () => {
    if (!values.username) {
      handleErrorChange("usernameError")("Username is required!");
  ...
  const handleRegister = async () => {
    try {
      ...
      const createProfile = await supabaseClient.from("profiles").upsert({
        id: user?.id,
            ...
            <Box>
              ...
              >
                <TextField
                  ...
                  id="name"
                  required
                  error={Boolean(errorValues.usernameError)}
                  fullWidth={true}
                  ...
                  onChange={(
                    ...
                    handleErrorChange("usernameError")("");
                  }}
                  helperText={errorValues.usernameError}
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start" variant="standard">
                        <IconButton aria-label="username" edge="end" disabled>
                          <MailIcon />
                        </IconButton>
                      </InputAdornment>
                    ),
